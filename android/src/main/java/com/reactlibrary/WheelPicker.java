...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
     ...
     * @see #setCurtainColor(int)
     */
    private int mCurtainCornerRadius;
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mCurtainCornerRadius = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_curtain_corner_radius,
                getResources().getDimensionPixelSize(R.dimen.WheelCurtainCornerRadius));
    ...
    private void computeCurrentItemRect() {
        ...
        mRectCurrentItem.set(mRectDrawn.left, mWheelCenterY - mHalfItemHeight - 10, mRectDrawn.right,
                mWheelCenterY + mHalfItemHeight + 10);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (hasCurtain) {
            ...
            mPaint.setStyle(Paint.Style.FILL);
            mRectF.set(mRectCurrentItem);
            canvas.drawRoundRect(mRectF, mCurtainCornerRadius, mCurtainCornerRadius, mPaint);
        }
        // 是否需要绘制指示器
